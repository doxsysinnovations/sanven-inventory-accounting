...
<div class="bg-white rounded-lg shadow dark:bg-(--color-accent-dark) dark:text-white {{ $styleAttributes }}">
    <div class="mb-4 p-6 rounded-t-lg bg-gray-50 dark:bg-(--color-accent-4-dark) dark:text-white dark:rounded-t-lg">
    ...
    <div class="overflow-x-auto rounded-lg px-10">
