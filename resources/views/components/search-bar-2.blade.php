...
<div class="relative">
    <input
        ...
        class="w-full rounded border border-gray-300 bg-white 
            dark:bg-gray-800 pr-10 pl-4 py-2.5 text-sm text-gray-900 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" 
        class="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-500 dark:text-gray-400" 
