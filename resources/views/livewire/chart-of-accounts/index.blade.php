...
new class extends Component {
    ...
    public function markAsInactive(int $id)
    {
        ...
        $this->dispatch('notify', 'Marked as inactive.');
    }
    public function markAsActive(int $id)
    {
        ...
        $this->dispatch('notify', 'Marked as active.');
    }
    ...
    public function getChartOfAccountsProperty()
    {
        return $this->filteredAccountsQuery()->latest()->paginate($this->perPage);
    }
    protected function filteredAccountsQuery()
    {
        return \App\Models\ChartOfAccount::query()
            ->when($this->search, function ($query) {
                $query->where('code', 'like', '%' . $this->search . '%')->orWhere('name', 'like', '%' . $this->search . '%');
            })
    ...
    {
        $this->selectedAccount = \App\Models\ChartOfAccount::find($id);
    }
...
<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-lg font-semibold">List of Chart of Accounts</h2>
            <p class="text-sm text-gray-600 dark:text-gray-300">
                This section displays the complete list of accounts used to record financial transactions, organized by
    ...
    <div class="flex justify-between overflow-x-auto mb-8 gap-6">
        ...
        <div
            ...
            <div>
                <h5 class="text-base font-medium text-gray-800 dark:text-gray-100">Total Assets</h5>
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ $this->totalPayablesCount }}</p>
       ...
       bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
           ...
           text-blue-500 flex justify-center items-center">
            ...
            <div>
                <h5 class="text-base font-medium text-gray-800 dark:text-gray-100">Total Liabilities</h5>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    {{ $this->approvedPayablesCount }}
                </p>
                <h6 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
       ...
       bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
           ...
           text-green-500 flex justify-center items-center">
            ...
            <div>
                <h5 class="text-base font-medium text-gray-800 dark:text-gray-100">Equity</h5>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    {{ $this->paidPayablesCount }}
                </p>
                <h6 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
        ...
        <div
            ...
            <div>
                <h5 class="text-base font-medium text-gray-800 dark:text-gray-100">Net Income (YTD or Current Period)
                </h5>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        @if ($chartOfAccounts->isEmpty())
            <div class="p-8 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new chart of
                    accounts.</p>
                <div class="mt-6">
                    <a href="{{ route('invoicing.create') }}"
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($chartOfAccounts as $account)
                            <tr wire:key="account-{{ $account->id }}"
                                ...
                                <td
                                    class="px-6 capitalize py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span @class([
                                        ...
                                        {{ ucfirst($account->is_active ? 'Active' : 'Inactive') }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-1">
                                    ...
                                    @if ($account->is_active === 1)
                                        <button wire:click="markAsInactive({{ $account->id }})"
                                            class="cursor-pointer inline-flex items-center px-2 py-1 text-xs bg-gray-500 text-white rounded hover:bg-gray-600">
                                            Deactivate
                                        </button>
                                    @else
                                        <button wire:click="markAsActive({{ $account->id }})"
                                            class="cursor-pointer inline-flex items-center px-2 py-1 text-xs bg-green-500 text-white rounded hover:bg-green-600">
                                            Activate
                                        </button>
                                    @endif
                                </td>
