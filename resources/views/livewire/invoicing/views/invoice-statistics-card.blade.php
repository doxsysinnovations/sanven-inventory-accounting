...
<div class="flex gap-3 items-center sm:w-3/12 w-full cursor-pointer p-5 rounded-lg bg-gray-50 dark:bg-(--color-accent-4-dark) hover:bg-gray-200 dark:hover:bg-gray-700">
    @isset($iconSlot)
        {{ $iconSlot }}
    @else
    ...
    <div>
        ...
        <h6 class="text-sm font-semibold">₱{{ $value }}</h6>
    </div>
</div>