...
new class extends Component {
    ...
    {
        $this->selectedOrder = PurchaseOrder::with(['items', 'purchaser'])->find($id);
    ...
    {
        return PurchaseOrder::with(['purchaser'])
...
<div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2">Purchase Order</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                                        ...
                                        <div x-show="showDelete"
                                            ...
                                            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                ...
                                                <p class="text-sm text-gray-700 dark:text-gray-300 mb-6">
                                                    Are you sure you want to delete Purchase Order: <span class="font-bold">{{ $deleteOrder?->po_number }}</span>?
                                                </p>
        ...
        <div class="px-6 py-3">{{ $orders->links() }}</div>
        @endif
    </div>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="show" x-transition:enter="ease-out duration-300"
                ...
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div>
                            <span @class([
                                ...
                                'bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-100' =>
                                    isset($selectedOrder) && $selectedOrder->status === 'partially delivered',
                    ...
                    <!-- Invoice Items -->
                    <div class="mt-6">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">PURCHASRE ORDER DETAILS</h4>
                                    ...
                                    @foreach ($selectedOrder->items ?? [] as $item)
                                        <tr>
                                            <td
                                                ...
                                                ({{ $item->product->product_code ?? 'N/A' }}) {{ $item->product->name ?? 'N/A' }}
                                            </td>
                                            <td
                                                class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse items-center">
                        ...
                        @can('purchase-orders.update-status')
                            <div x-data="{ showStatusDropdown: false }" class="flex items-center gap-2 mr-auto">
                                ...
                                <template x-if="showStatusDropdown">
                                    <form wire:submit.prevent="updateStatus({{ $selectedOrder->id }})" class="flex items-center gap-2 animate-fade-in" @click.away="showStatusDropdown = false">
                                        <select wire:model.defer="statusUpdate"
                                            class="rounded-md border px-3 py-2 text-sm font-semibold shadow focus:ring-2 focus:ring-yellow-400 transition
                                                ...
                                                @else bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100 @endif
                                            ">
                                            <option value="pending" class="bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-100">Pending</option>
                                            <option value="partially delivered" class="bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-100">Partially Delivered</option>
                                            <option value="delivered" class="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100">Delivered</option>
                                            <option value="closed" class="bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-100">Closed</option>
                                            <option value="cancelled" class="bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100">Cancelled</option>
                                        </select>
                                        <button type="submit"
